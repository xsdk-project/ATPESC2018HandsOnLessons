# Krylov Solvers, Algebraic Multigrid, and Impact of Data Structures
...
----------------------------|----------- -------------------------|--------------------------
Why multigrid over Krylov   |Understand multigrid concept         |Faster convergence,
solvers for large problems? |                                     |better scalability
...
The linear system to be solved is generated using central finite differences from the Poisson equation:

![equation](http://latex.codecogs.com/gif.latex?%5Cvarphi-%5CDelta%5Ccdot%5Cbeta%5Cnabla%5Cvarphi%3DRHS)

with Dirichlet boundary conditions.

The grid is a cuboid consisting of n x m x k cells, where n,m, and k can be varied.
